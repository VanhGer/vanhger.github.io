...
thumbnail: "assets/img/feature-img/post3.png"
tags: [Software]
author: vanhg
...
## Table of contents
* [Mở đầu](#Mu)
* [3. Bản mẫu (Prototype)](#BnmuPrototype)
* [4. Mô hình xoắn ốc (Spiral model):](#MhnhxoncSpiralmodel:)
* [5. Tổng hợp:](#Tnghp:)
...
##  <a name='BnmuPrototype'></a>3. Bản mẫu (Prototype)
...
##  <a name='MhnhxoncSpiralmodel:'></a>4. Mô hình xoắn ốc (Spiral model):
