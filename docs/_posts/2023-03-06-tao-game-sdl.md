...
## Table of contents
* [Mở đầu](#Mu)
* [1. Cài đặt môi trường và sử dụng SDL2.0](#CitmitrngvsdngSDL2.0)
* [2. Ý tưởng về game này](#tngvgameny)
* [3. Thử thách thứ nhất.](#Ththchthnht.)
* [4. Thử thách thứ hai](#Ththchthhai)
* [5. Thử thách thứ ba](#Ththchthba)
* [6. Thử thách cuối cùng](#Ththchcuicng)
* [7. Những phần phụ khác](#Nhngphnphkhc)
* [Tổng kết](#Tngkt)
...
##  <a name='CitmitrngvsdngSDL2.0'></a>1. Cài đặt môi trường và sử dụng SDL2.0
...
{% include aligner.html images="post-pic/post4-7.png" column = 1 %}
...
##  <a name='tngvgameny'></a>2. Ý tưởng về game này
...
{% include aligner.html images="post-pic/post4-8.png" column = 1 %}

##  <a name='Ththchthnht.'></a>3. Thử thách thứ nhất.
...
{% include aligner.html images="post-pic/post4-1.png" column = 1 %}

## <a name='Ththchthhai'></a>4. Thử thách thứ hai
...
{% include aligner.html images="post-pic/post4-2.png" column = 1 %}

##  <a name='Ththchthba'></a>5. Thử thách thứ ba
...
{% include aligner.html images="post-pic/post4-3.png" column = 1 %}

##  <a name='Ththchcuicng'></a>6. Thử thách cuối cùng
...
{% include aligner.html images="post-pic/post4-4.png" column = 1 %}


## <a name='Nhngphnphkhc'></a>7. Những phần phụ khác
...
{% include aligner.html images="post-pic/post4-6.png,post-pic/post4-5.png" %}
