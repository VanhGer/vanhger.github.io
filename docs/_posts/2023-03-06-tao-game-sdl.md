...
{% include aligner.html images="post-pic/post4-7.png" column = 3 %}
...
{% include aligner.html images="post-pic/post4-8.png" column = 3 %}
...
{% include aligner.html images="post-pic/post4-1.png" column = 3 %}
...
{% include aligner.html images="post-pic/post4-2.png" column = 3 %}
...
{% include aligner.html images="post-pic/post4-3.png" column = 3 %}
...
{% include aligner.html images="post-pic/post4-4.png" column = 3 %}
